...
shaka.Player = class extends shaka.util.FakeEventTarget {
  ...
  load(assetUri, startTime, mimeType) {
    ...
    shaka.log.debug('jobispo player load', Date.now() - time0);
  ...
  async onUnload_(has, wants) {
    ...
    shaka.log.debug('jobispo onUnload0', Date.now() - time0);
    time0 = Date.now();

    // Dispatch the unloading event.
    this.dispatchEvent(this.makeEvent_(shaka.Player.EventName.Unloading));

    shaka.log.debug('jobispo onUnload1', Date.now() - time0);
    time0 = Date.now();
    ...
    shaka.log.debug('jobispo onUnload2', Date.now() - time0);
    time0 = Date.now();
    ...
    shaka.log.debug('jobispo onUnload3', Date.now() - time0);
    time0 = Date.now();
    ...
    shaka.log.debug('jobispo onUnload4', Date.now() - time0);
    time0 = Date.now();
    ...
    shaka.log.debug('jobispo onUnload5', Date.now() - time0);
    time0 = Date.now();
    ...
    shaka.log.debug('jobispo onUnload6', Date.now() - time0);
    time0 = Date.now();
    ...
    shaka.log.debug('jobispo onUnload7', Date.now() - time0);
    time0 = Date.now();
    ...
    shaka.log.debug('jobispo onUnload8', Date.now() - time0);
    time0 = Date.now();
    ...
    shaka.log.debug('jobispo onUnload9', Date.now() - time0);
    time0 = Date.now();
    ...
    shaka.log.debug('jobispo onUnload10', Date.now() - time0);
    time0 = Date.now();
    ...
    shaka.log.debug('jobispo onUnload11', Date.now() - time0);
    time0 = Date.now();
    ...
    shaka.log.debug('jobispo onUnload12', Date.now() - time0);
    time0 = Date.now();
    ...
    shaka.log.debug('jobispo onUnload13', Date.now() - time0);
  }
 ...
 * @export
 */
shaka.Player.version = 'v3.0.13-uncompiled';
