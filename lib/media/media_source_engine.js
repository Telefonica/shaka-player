...
shaka.media.MediaSourceEngine = class {
  ...
  async doDestroy_() {
    ...
    shaka.log.debug('jobispo destroy4', Date.now() - time0);
    time0 = Date.now();
    ...
    shaka.log.debug('jobispo destroy5', Date.now() - time0);
    time0 = Date.now();
    ...
    this.queues_ = {};
    shaka.log.debug('jobispo destroy6', Date.now() - time0);
  }
