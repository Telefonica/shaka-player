                ...
                if (comparison1 < scaledMediaDecodeTime) {
                  ...
                  await this.playerInterface_.mediaSourceEngine
                      .setStreamProperties(
                          ...
                          lastAppendWindowEnd, ignoreTimestampOffset,
        ...
        const append = async () => {
          try {
            ...
            if (mediaState.type ===
                  ...
                  timescaleMap.has(mediaState.type)) {
              timescale = timescaleMap.get(mediaState.type);
              shaka.log.v1(logPrefix, 'timescale', timescale);
            }
