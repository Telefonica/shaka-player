...
/**
 * jobispo. Resets bytesSampled property in bandwidthEstimator
 */
shaka.abr.SimpleAbrManager.prototype.reset = function() {
  this.bandwidthEstimator_ && this.bandwidthEstimator_.reset();
};
