...
* **ads:** allow adsResponse for making ad request ([#2946](https://github.com/Telefonica/stv-shaka-player/issues/2946)) ([40d4451](https://github.com/Telefonica/stv-shaka-player/commit/40d44517b9dbc87cb1c74d14f9b9c0969c16a659)), closes [#2892](https://github.com/Telefonica/stv-shaka-player/issues/2892)
...
* Allow switching between mono and stereo tracks ([#2911](https://github.com/Telefonica/stv-shaka-player/issues/2911)) ([4aa0856](https://github.com/Telefonica/stv-shaka-player/commit/4aa08568dce935760e11437f3d6244e6dcd37834)), closes [#2908](https://github.com/Telefonica/stv-shaka-player/issues/2908)
...
* deduplicate text streams in period flattening ([#2885](https://github.com/Telefonica/stv-shaka-player/issues/2885)) ([54d48e1](https://github.com/Telefonica/stv-shaka-player/commit/54d48e1a46e7264e4a7ced4676017ae91cf2c5b8))
...
* **ll-Dash:** Add new low latency DASH manifest ([#2963](https://github.com/Telefonica/stv-shaka-player/issues/2963)) ([9d59f72](https://github.com/Telefonica/stv-shaka-player/commit/9d59f72f52d4a918b5e2fefd8265bc47609a4c19))
* **LL-Dash:** Check whether ReadableStream is supported ([904d8f2](https://github.com/Telefonica/stv-shaka-player/commit/904d8f29c6ed3c1bf12d4f3f6c637dc5f29ef0ac)), closes [#1525](https://github.com/Telefonica/stv-shaka-player/issues/1525)
* **LL-Dash:** Fetch and append ReadableStream ([f67367a](https://github.com/Telefonica/stv-shaka-player/commit/f67367a81b6dc419f27504286dd9b517b0e68be9)), closes [#1525](https://github.com/Telefonica/stv-shaka-player/issues/1525)
* **LL-Dash:** Parse and append ReadableStream by MP4 boxes ([40d0359](https://github.com/Telefonica/stv-shaka-player/commit/40d0359732245a4eb9699acdd57d5a64407a5f6a)), closes [#1525](https://github.com/Telefonica/stv-shaka-player/issues/1525)
...
* **ll-hls:** Parse BYTERANGE-START tag ([20cc6b5](https://github.com/Telefonica/stv-shaka-player/commit/20cc6b53a2f7f88730142db3c64442d2d07c0d0a)), closes [#1525](https://github.com/Telefonica/stv-shaka-player/issues/1525)
* **LL-HLS:** Set default streaming config for low latency ([1e8f8bb](https://github.com/Telefonica/stv-shaka-player/commit/1e8f8bbf1f6093b6b0c2b2f16742688dad3c51a3)), closes [#1525](https://github.com/Telefonica/stv-shaka-player/issues/1525)
...
* **LowLatency:** Show warning if lowLatencyMode should be enabled ([281d3ed](https://github.com/Telefonica/stv-shaka-player/commit/281d3ed96f71b689e38392b6d654732fce878bf9))
* **LowLatency:** Show warning if lowLatencyMode should be enabled ([ac4fb76](https://github.com/Telefonica/stv-shaka-player/commit/ac4fb76e05166f19560c3d44020f00d2e523749b)), closes [#1525](https://github.com/Telefonica/stv-shaka-player/issues/1525)
...
* **player:** Add label to LanguageRole externs ([98df64c](https://github.com/Telefonica/stv-shaka-player/commit/98df64c1af61490bdc926cfbf89a0d621e3a77cf)), closes [#2904](https://github.com/Telefonica/stv-shaka-player/issues/2904)
...
* **text:** Add addTextTrackAsync ([#2932](https://github.com/Telefonica/stv-shaka-player/issues/2932)) ([faa1e52](https://github.com/Telefonica/stv-shaka-player/commit/faa1e52902bcf2b6d9d6b7067794236c41ec0cee))
...
* **text:** Add polyfill for TextDecoder/TextEncoder ([1405997](https://github.com/Telefonica/stv-shaka-player/commit/1405997a35a9b1a155de5a8c93d3104b1d0f0c5a))
* **text:** Add support to side-load subtitles in src mode ([#2874](https://github.com/Telefonica/stv-shaka-player/issues/2874)) ([4659a97](https://github.com/Telefonica/stv-shaka-player/commit/4659a97c8bf886e77d7251459a5cefb3738a1877))
...
* **ui:** Allow apps to register a custom seek bar UI implementation ([#2966](https://github.com/Telefonica/stv-shaka-player/issues/2966)) ([f073abc](https://github.com/Telefonica/stv-shaka-player/commit/f073abc6f5deefccb51f62265211438cfea782ec)), closes [#2924](https://github.com/Telefonica/stv-shaka-player/issues/2924)
* **ui:** Allow showing track labels in UI ([c7d0ce9](https://github.com/Telefonica/stv-shaka-player/commit/c7d0ce93d9c77c8aa17baae0e9f5f09aeacb6229)), closes [#2927](https://github.com/Telefonica/stv-shaka-player/issues/2927)
...
* **vp9:** Polyfill vp09 checks when only vp9 is recognized ([126a398](https://github.com/Telefonica/stv-shaka-player/commit/126a398c70a311e0c82895e417bf41ebc10b241d)), closes [#2870](https://github.com/Telefonica/stv-shaka-player/issues/2870)
...
* Avoid a race when clearing buffered content ([d4d014b](https://github.com/Telefonica/stv-shaka-player/commit/d4d014bd55b45c52a729dcbbdd034b2e1175e351))
...
* b/166852391 ([1db1382](https://github.com/Telefonica/stv-shaka-player/commit/1db13826a3bf149adf6907cf13c33f993fc538e1))
* ban new Date.getTime() ([#2857](https://github.com/Telefonica/stv-shaka-player/issues/2857)) ([ee5fe52](https://github.com/Telefonica/stv-shaka-player/commit/ee5fe5238a0bd2b956633ad005061f78f5a50005))
...
* **cast:** Fix Shaka+Cast apps using IndexedDB ([256f89d](https://github.com/Telefonica/stv-shaka-player/commit/256f89dff7f7c6c5734e5aa5614280c8576886bd))
...
* correctly detect Edge Chromium as Edge ([#2855](https://github.com/Telefonica/stv-shaka-player/issues/2855)) ([a344f10](https://github.com/Telefonica/stv-shaka-player/commit/a344f1017d1d3fe3db1d2bd3a9c32949b31870b0))
...
* **doc:** Export UI externs ([2d88f8c](https://github.com/Telefonica/stv-shaka-player/commit/2d88f8c3271195f42d42df23b1732e9b0aa94f79)), closes [#2948](https://github.com/Telefonica/stv-shaka-player/issues/2948)
...
* Don't apply seek range while content is still loading ([#2849](https://github.com/Telefonica/stv-shaka-player/issues/2849)) ([6af6e00](https://github.com/Telefonica/stv-shaka-player/commit/6af6e0087054df560b7874005bb36073324258f3)), closes [#2748](https://github.com/Telefonica/stv-shaka-player/issues/2748)
...
* **drm:** Fix application of DRM server certificate ([acc4c0e](https://github.com/Telefonica/stv-shaka-player/commit/acc4c0e2574874d2aaa9f2e7d177024d729d330b)), closes [#2644](https://github.com/Telefonica/stv-shaka-player/issues/2644)
...
* Fix compatibility for plugin factories ([9ece285](https://github.com/Telefonica/stv-shaka-player/commit/9ece285b92261237b9d3111d5ce0616250f7bd81)), closes [#2958](https://github.com/Telefonica/stv-shaka-player/issues/2958)
...
* Fix non-deterministic exception in StreamingEngine ([e1b4344](https://github.com/Telefonica/stv-shaka-player/commit/e1b434497c296d463542f353e4ada5e52bd8f636)), closes [#2768](https://github.com/Telefonica/stv-shaka-player/issues/2768)
...
* Fix rapid seeking leading to infinite buffering ([20c08d3](https://github.com/Telefonica/stv-shaka-player/commit/20c08d380d6bd29e10d75c9c0f0ffc4aaa2e9f18)), closes [#2670](https://github.com/Telefonica/stv-shaka-player/issues/2670)
...
* **hls:** Allow config to play video-only HLS. ([7941703](https://github.com/Telefonica/stv-shaka-player/commit/7941703c5afddeaf890359d3243cd2c0a7b841f9)), closes [#2868](https://github.com/Telefonica/stv-shaka-player/issues/2868)
...
* **HLS:** Fix interpretation of DEFAULT and AUTOSELECT ([3d9510a](https://github.com/Telefonica/stv-shaka-player/commit/3d9510af88fc9ded3113263cec9c0c38fa5f4ae6)), closes [#2880](https://github.com/Telefonica/stv-shaka-player/issues/2880)
...
* **hls:** Recognize the types of mp4a and mp4v extensions ([ad009b6](https://github.com/Telefonica/stv-shaka-player/commit/ad009b6d2f2ae670ae332f9154b23af571df2824))
...
* **hls:** Support multiple CHARACTERISTICS values in HLS ([#2905](https://github.com/Telefonica/stv-shaka-player/issues/2905)) ([f7626ff](https://github.com/Telefonica/stv-shaka-player/commit/f7626ff60a8dea7391fb8eab5369634727eb3bf3)), closes [#2903](https://github.com/Telefonica/stv-shaka-player/issues/2903)
...
* **LL-Dash:** Fix test with ReadableStream unsupported ([8f02023](https://github.com/Telefonica/stv-shaka-player/commit/8f020237d5286fc806f225e99acb4efe1ac2bb3b))
...
* **media:** Fix initSegment requests on manifest updates ([#2942](https://github.com/Telefonica/stv-shaka-player/issues/2942)) ([3484ac8](https://github.com/Telefonica/stv-shaka-player/commit/3484ac8c7c236c76b69d887a17688b39985a93d4)), closes [#2856](https://github.com/Telefonica/stv-shaka-player/issues/2856)
...
* **periods:** Ignore streams with period-specific codecs ([f7aacf1](https://github.com/Telefonica/stv-shaka-player/commit/f7aacf151c83114085344e6df1b3ad1513697558)), closes [#2883](https://github.com/Telefonica/stv-shaka-player/issues/2883)
...
* support TTML background image's region positioning ([a9a1695](https://github.com/Telefonica/stv-shaka-player/commit/a9a1695d2284de24db3b48d038c40edd25b8fd2c)), closes [#2703](https://github.com/Telefonica/stv-shaka-player/issues/2703)
...
* **test:** Fix test failure on IE11 ([b105199](https://github.com/Telefonica/stv-shaka-player/commit/b105199276653b73328f16b93c8ee80fdb47d3a8))
* **test:** update TextDislayer cues screenshots ([1db1382](https://github.com/Telefonica/stv-shaka-player/commit/1db13826a3bf149adf6907cf13c33f993fc538e1))
* **text:** Add error codes to addTextTrack errors ([#2930](https://github.com/Telefonica/stv-shaka-player/issues/2930)) ([919e3ef](https://github.com/Telefonica/stv-shaka-player/commit/919e3efe949be31c478b437387c3b9487f321861))
...
* **text:** Make UITextDisplayer CSS-independent ([#2819](https://github.com/Telefonica/stv-shaka-player/issues/2819)) ([59ee6ba](https://github.com/Telefonica/stv-shaka-player/commit/59ee6baff4374083d03c5991a8fb626b944ee908)), closes [#2817](https://github.com/Telefonica/stv-shaka-player/issues/2817)
...
* TTML clean up ([7e4280f](https://github.com/Telefonica/stv-shaka-player/commit/7e4280fab4bb29f346cac1a6da5120236a61457b)), closes [#2623](https://github.com/Telefonica/stv-shaka-player/issues/2623) [#2761](https://github.com/Telefonica/stv-shaka-player/issues/2761)
...
* **ttml:** Fix another hard-coded namespace. ([20923cc](https://github.com/Telefonica/stv-shaka-player/commit/20923cca5d9aa62e27e5bd200ed5393bb37097ea)), closes [#2756](https://github.com/Telefonica/stv-shaka-player/issues/2756)
...
* **ui:** Don't play after seeking while paused ([#2898](https://github.com/Telefonica/stv-shaka-player/issues/2898)) ([90d99f2](https://github.com/Telefonica/stv-shaka-player/commit/90d99f229ca0e35394a3680a97ab2aea4e74045f))
* **ui:** Export FakeEvent for use by UI plugins ([3eca747](https://github.com/Telefonica/stv-shaka-player/commit/3eca74721d416d9c224b40452828a00c25ee4f96)), closes [#2923](https://github.com/Telefonica/stv-shaka-player/issues/2923)
...
* **ui:** Fix hiding controls on mobile after closing menu ([bfc2a75](https://github.com/Telefonica/stv-shaka-player/commit/bfc2a75d16c498e57a64f65b8dd2c7d51ebfb438)), closes [#2886](https://github.com/Telefonica/stv-shaka-player/issues/2886)
* **ui:** Fix hiding controls on mobile after touch ([918cfd7](https://github.com/Telefonica/stv-shaka-player/commit/918cfd7e6393827bf84100767d408db5ff98ad86)), closes [#2886](https://github.com/Telefonica/stv-shaka-player/issues/2886)
...
* **ui:** Fix renaming of UI base class protected members ([5001086](https://github.com/Telefonica/stv-shaka-player/commit/50010869010c9caeadf5ec53de4c341a9f390cf1)), closes [#2923](https://github.com/Telefonica/stv-shaka-player/issues/2923)
...
* **ui:** Ignore seek touch events on hidden controls ([5e559c3](https://github.com/Telefonica/stv-shaka-player/commit/5e559c3797ae49f6d59114ce393cc9b6dbf427a9)), closes [#2888](https://github.com/Telefonica/stv-shaka-player/issues/2888)
* **ui:** Make submenu CSS apply to all submenus ([abd8b3b](https://github.com/Telefonica/stv-shaka-player/commit/abd8b3b43a8fa6b7d4075cadcc17f0d0bb8fce99)), closes [#2925](https://github.com/Telefonica/stv-shaka-player/issues/2925)
